    ...
    <>
      ...
      >
        ...
        <div className="p-5">
          ...
          {accessType?.length > 0 && (
            <div>
              <h4 className="font-semibold text-sm pb-1 pt-2">Access Types</h4>
  ...
  return (
    <>
      ...
      <AlertDialog open={open} onOpenChange={setOpen}>
        <AlertDialogTrigger>
          ...
          >
            ...
            >
              <div>
                <h3
                  className={`font-bold text-base text-start w-full line-clamp-2 ${hasAccess && "pb-5"}`}
                >
                  {name}
                </h3>
              </div>
        ...
        {isMobile && (
          <AlertDialogContent
            className={`bg-transparent border-0 p-0 flex justify-center items-center`}
          >
            {floatingCard}
          </AlertDialogContent>
        )}
